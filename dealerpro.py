...
def get_customs_fee(price_rub):
    # Финальные проиндексированные ставки таможенного оформления
    ...
    elif price_rub <= 4200000: return 18465  # Скорректировано под точный тариф ТКС
...
def get_util_fee(age_idx, vol, hp):
    ...
    if hp > 160 or vol > 3000:
        ...
        else: return 4581600 if is_new else 5565200  # Обновлено до 4 581 600 ₽ для объемов > 3.5л
    else:
